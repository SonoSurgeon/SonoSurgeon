...
TASK_DIR="${PROJECT_ROOT}/source/spinal_surgery/spinal_surgery/tasks/robot_US_guidance"

AGENT_CFG="${TASK_DIR}/agents/skrl_ppo_cfg.yaml"
TRAIN_SCRIPT="${PROJECT_ROOT}/workflows/skrl/train.py"

TASK_NAME="Isaac-robot-US-guidance-v0"
...
# /home/idsia/SonoGym/logs/skrl/US_guidance/PPO_guidance_seedX/
cfg["agent"]["experiment"]["directory"] = "US_guidance"
