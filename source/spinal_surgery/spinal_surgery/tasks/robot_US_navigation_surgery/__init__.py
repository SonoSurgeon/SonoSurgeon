...
gym.register(
    id="Isaac-robot-US-navigation-surgery-v0",
    entry_point=f"{__name__}.robotic_US_navigation_surgery:roboticUSNavigationSurgeryEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.robotic_US_navigation_surgery:roboticUSNavigationSurgeryCfg",
