...
gym.register(
    id="Isaac-robot-US-guided-surgery-G1-v0",
    entry_point=f"{__name__}.robotic_US_guided_surgery_G1:roboticUSGuidedSurgeryEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.robotic_US_guided_surgery_G1:roboticUSGuidedSurgeryCfg",
