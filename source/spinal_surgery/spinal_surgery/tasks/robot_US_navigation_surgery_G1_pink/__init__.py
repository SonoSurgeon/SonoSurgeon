...
gym.register(
    id="Isaac-robot-US-navigation-surgery-G1-pink-v0",
    entry_point=f"{__name__}.robotic_US_navigation_surgery_G1_pink:roboticUSNavigationSurgeryEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.robotic_US_navigation_surgery_G1_pink:roboticUSNavigationSurgeryCfg",
