...
TASK_DIR="${PROJECT_ROOT}/source/spinal_surgery/spinal_surgery/tasks/robot_US_guided_surgery"

AGENT_CFG="${TASK_DIR}/agents/skrl_ppo_cfg_large.yaml"
TRAIN_SCRIPT="${PROJECT_ROOT}/workflows/skrl/train.py"

TASK_NAME="Isaac-robot-US-guided-surgery-v0"
...
# /home/idsia/SonoGym/logs/skrl/surgery_large/PPO_surgery_large_seedX/
cfg["agent"]["experiment"]["directory"] = "surgery_large"
